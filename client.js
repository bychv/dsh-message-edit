window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:F:\Git\dsh-messege-edit\src\client\InlineMessageEdit.module.css.mjs
		const css$2 = ".LRkRdW_overlay{z-index:1000;background:var(--dsw-alias-bg-mask,#00000073);justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.LRkRdW_panel{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:10px;width:560px;padding:14px 16px}.LRkRdW_title{color:var(--dsw-alias-label-primary);padding:4px 0 10px;font-size:13px}.LRkRdW_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);width:100%;min-height:160px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:10px}.LRkRdW_footer{justify-content:flex-end;gap:8px;padding:10px 0 0;display:flex}.LRkRdW_footer button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-hover);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:6px;padding:6px 14px}.LRkRdW_iconButton{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:4px;justify-content:center;align-items:center;padding:2px;display:inline-flex}.LRkRdW_iconButton:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-module-hover)}.LRkRdW_picker{flex-direction:column;gap:6px;padding:4px 0 12px;display:flex}.LRkRdW_pickerItem{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-hover);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;border-radius:6px;padding:8px 10px;font-size:12px}.LRkRdW_pickerItem:hover{background:var(--dsw-alias-bg-module-platform)}.LRkRdW_pickerItemActive{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-hover);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:6px;align-self:flex-end;padding:6px 14px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:F:\Git\dsh-messege-edit\src\client\MessageEditHeader.module.css.mjs
		const css$1 = ".kmIVpW_root{align-items:center;gap:4px;display:inline-flex}.kmIVpW_iconButton,.kmIVpW_rerollButton{box-sizing:border-box;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0}.kmIVpW_iconButton{border-radius:50%;justify-content:center;align-items:center;width:28px;height:28px;font-size:16px;line-height:20px;display:inline-flex}.kmIVpW_rerollButton{border:1px solid var(--dsw-alias-border-l2);border-radius:14px;height:28px;padding:0 10px;font-size:12px;line-height:18px}.kmIVpW_iconButton:hover:not(:disabled),.kmIVpW_rerollButton:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.kmIVpW_iconButton:focus-visible,.kmIVpW_rerollButton:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}.kmIVpW_iconButton:disabled,.kmIVpW_rerollButton:disabled{cursor:default;opacity:.4}.kmIVpW_counter{min-width:108px;color:var(--dsw-alias-label-tertiary);text-align:center;font-size:11px;line-height:18px}@media (width<=760px){.kmIVpW_counter{display:none}}";
		...
		//#endregion
		//#region \0dsh-css:F:\Git\dsh-messege-edit\src\client\MessageEditTimelineView.module.css.mjs
		const css = ".pdbLWq_root{box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);padding:24px;overflow:auto}.pdbLWq_pageHeader{justify-content:space-between;align-items:flex-start;gap:20px;max-width:1480px;margin:0 auto 16px;display:flex}.pdbLWq_title,.pdbLWq_intro,.pdbLWq_subtitle,.pdbLWq_notice,.pdbLWq_error,.pdbLWq_empty,.pdbLWq_turnTitle,.pdbLWq_turnPreview,.pdbLWq_messageText{margin:0}.pdbLWq_title{font-size:22px;font-weight:600;line-height:30px}.pdbLWq_intro{max-width:700px;color:var(--dsw-alias-label-tertiary);margin-top:4px;font-size:13px;line-height:20px}.pdbLWq_headerActions{flex:none;align-items:flex-end;gap:8px;display:flex}.pdbLWq_cascadeField{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;font-size:11px;line-height:16px;display:flex}.pdbLWq_select,.pdbLWq_textarea,.pdbLWq_primaryButton,.pdbLWq_secondaryButton,.pdbLWq_textButton,.pdbLWq_versionButton{box-sizing:border-box;font:inherit}.pdbLWq_select,.pdbLWq_textarea{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px}.pdbLWq_select{height:34px;padding:0 30px 0 9px;font-size:12px}.pdbLWq_primaryButton,.pdbLWq_secondaryButton,.pdbLWq_textButton,.pdbLWq_versionButton{cursor:pointer;border:0}.pdbLWq_primaryButton,.pdbLWq_secondaryButton{border-radius:17px;justify-content:center;align-items:center;min-height:34px;padding:0 13px;font-size:12px;line-height:18px;display:inline-flex}.pdbLWq_primaryButton{color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-primary-fill)}.pdbLWq_primaryButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.pdbLWq_secondaryButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.pdbLWq_secondaryButton:hover:not(:disabled),.pdbLWq_textButton:hover:not(:disabled),.pdbLWq_versionButton:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.pdbLWq_primaryButton:disabled,.pdbLWq_secondaryButton:disabled,.pdbLWq_textButton:disabled,.pdbLWq_versionButton:disabled,.pdbLWq_select:disabled{cursor:default;opacity:.45}.pdbLWq_primaryButton:focus-visible,.pdbLWq_secondaryButton:focus-visible,.pdbLWq_textButton:focus-visible,.pdbLWq_versionButton:focus-visible,.pdbLWq_select:focus-visible,.pdbLWq_textarea:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}.pdbLWq_notice,.pdbLWq_error{max-width:1480px;margin:0 auto 10px;font-size:12px;line-height:18px}.pdbLWq_notice{color:var(--dsw-alias-state-warn-label)}.pdbLWq_error{color:var(--dsw-alias-state-error-primary)}.pdbLWq_status{box-sizing:border-box;width:100%;height:100%;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;align-items:flex-start;gap:12px;padding:24px;display:flex}.pdbLWq_status .pdbLWq_error{margin:0}.pdbLWq_columns{grid-template-columns:minmax(280px,.72fr) minmax(520px,1.75fr);align-items:start;gap:18px;max-width:1480px;margin:0 auto;display:grid}.pdbLWq_versionsPanel,.pdbLWq_turnsPanel{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-radius:14px;min-width:0;padding:16px}.pdbLWq_versionsPanel{position:sticky;top:0}.pdbLWq_sectionHeading{justify-content:space-between;align-items:center;gap:12px;margin-bottom:14px;display:flex}.pdbLWq_effectControls{background:var(--dsw-alias-bg-module-platform);border-radius:9px;flex-direction:column;gap:8px;margin-bottom:12px;padding:10px;display:flex}.pdbLWq_effectDepth{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.pdbLWq_effectButtons{flex-wrap:wrap;gap:6px;display:flex}.pdbLWq_effectButtons .pdbLWq_secondaryButton{min-height:28px;padding:0 10px;font-size:11px}.pdbLWq_subtitle{font-size:16px;font-weight:500;line-height:24px}.pdbLWq_count{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.pdbLWq_versionList,.pdbLWq_turnList{margin:0;padding:0;list-style:none}.pdbLWq_versionList{flex-direction:column;gap:4px;display:flex}.pdbLWq_versionItem{--message-edit-depth:0;padding-left:calc(var(--message-edit-depth) * 14px);position:relative}.pdbLWq_versionButton{width:100%;min-width:0;color:var(--dsw-alias-label-secondary);text-align:left;background:0 0;border-radius:9px;align-items:flex-start;gap:9px;padding:9px;display:flex;position:relative}.pdbLWq_versionButton[data-current]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-module-platform);opacity:1}.pdbLWq_versionButton:not([data-current]) .pdbLWq_pathBadge{opacity:.8}.pdbLWq_versionLine{background:var(--dsw-alias-border-l2);width:1px;position:absolute;top:0;bottom:0;left:14px}.pdbLWq_versionDot{z-index:1;border:2px solid var(--dsw-alias-bg-layer-1);background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:7px;height:7px;margin-top:6px}.pdbLWq_versionButton[data-current] .pdbLWq_versionDot{border-color:var(--dsw-alias-bg-module-platform);background:var(--dsw-alias-brand-primary)}.pdbLWq_versionMain{flex-direction:column;flex:1;min-width:0;display:flex}.pdbLWq_versionTitle{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.pdbLWq_versionMeta{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:16px;overflow:hidden}.pdbLWq_versionDiff{color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:2px;margin-top:5px;font-size:10px;line-height:15px;display:flex}.pdbLWq_versionDiff span{-webkit-line-clamp:2;white-space:pre-wrap;overflow-wrap:anywhere;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.pdbLWq_currentBadge,.pdbLWq_pathBadge,.pdbLWq_kindBadge{border-radius:9px;flex:none;padding:1px 6px;font-size:10px;line-height:17px}.pdbLWq_currentBadge{color:var(--dsw-alias-brand-primary);background:var(--dsw-alias-bg-layer-1)}.pdbLWq_pathBadge{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1)}.pdbLWq_turnList{flex-direction:column;gap:14px;display:flex}.pdbLWq_turnSection{border:1px solid var(--dsw-alias-border-l2);border-radius:11px;padding:13px}.pdbLWq_turnHeader,.pdbLWq_messageHeader,.pdbLWq_editorActions{justify-content:space-between;align-items:center;gap:10px;display:flex}.pdbLWq_turnHeader{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-start;padding-bottom:11px}.pdbLWq_turnTitle{font-size:14px;font-weight:500;line-height:22px}.pdbLWq_turnPreview{max-width:700px;color:var(--dsw-alias-label-tertiary);-webkit-line-clamp:2;white-space:pre-wrap;-webkit-box-orient:vertical;font-size:11px;line-height:17px;display:-webkit-box;overflow:hidden}.pdbLWq_messageList{flex-direction:column;gap:8px;margin-top:10px;display:flex}.pdbLWq_messageCard{background:var(--dsw-alias-bg-module-platform);border-radius:9px;padding:10px}.pdbLWq_messageHeader{justify-content:flex-start}.pdbLWq_kindBadge{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1)}.pdbLWq_kindBadge[data-kind=assistant\\.reasoning]{color:var(--dsw-alias-label-tertiary)}.pdbLWq_messageTime{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:17px}.pdbLWq_textButton{color:var(--dsw-alias-label-secondary);background:0 0;border-radius:12px;margin-left:auto;padding:3px 8px;font-size:11px;line-height:17px}.pdbLWq_messageText{max-height:220px;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin-top:7px;font-family:inherit;font-size:12px;line-height:19px;overflow:auto}.pdbLWq_editor{margin-top:8px}.pdbLWq_textarea{resize:vertical;width:100%;min-height:120px;padding:9px;font-size:12px;line-height:19px}.pdbLWq_editorActions{margin-top:8px}.pdbLWq_editorHint{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:16px}.pdbLWq_empty{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);border-radius:10px;padding:18px;font-size:13px;line-height:20px}@media (width<=1000px){.pdbLWq_columns{grid-template-columns:1fr}.pdbLWq_versionsPanel{position:static}}@media (width<=680px){.pdbLWq_root{padding:16px}.pdbLWq_pageHeader,.pdbLWq_headerActions,.pdbLWq_turnHeader,.pdbLWq_editorActions{flex-direction:column;align-items:stretch}.pdbLWq_headerActions,.pdbLWq_primaryButton,.pdbLWq_secondaryButton{width:100%}}";
